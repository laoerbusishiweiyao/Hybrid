...
$ProjectPath = "../../Server/Hotfix"
$Output = "../../$Configuration/Server"
...
# if (Test-Path $Output) {
#     Write-Information "🧹 正在清空目录..."
#     Remove-Item $Output -Recurse -Force
#     Write-Information "✅ 目录已清空。"
# }

Write-Information "📦 正在构建 Server Hotfix..."
...
Write-Information "✅ Server Hotfix 构建完成。"