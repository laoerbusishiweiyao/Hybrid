...
public sealed class SortedListDictionary<TKey, TValue>(int maxPoolCount = 0) : SortedDictionary<TKey, List<TValue>>
{
    private readonly List<TValue> empty = [];

    private readonly Queue<List<TValue>> poolQueue = new(maxPoolCount);
