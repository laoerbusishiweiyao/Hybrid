...
namespace Chaos
{
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ComponentCollection value)
        {
            if (value == null)
            {
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ComponentCollection value)
        {
