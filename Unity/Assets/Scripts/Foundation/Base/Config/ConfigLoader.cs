...
namespace Chaos
{
    public readonly struct ConfigDeserializeEventArgs
    {
        public readonly Type ConfigType;
        public readonly object ConfigBuffer;

        public ConfigDeserializeEventArgs(Type configType, object configBuffer)
        {
